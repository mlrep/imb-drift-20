...
public class OS_SMOTEErrorUniformNeighborsNumExperiment extends Experiment {

    private double budget;

    public OS_SMOTEErrorUniformNeighborsNumExperiment(String inputDir, String outputDir) {
    ...
    public List<ExperimentRow> createExperimentRows() {
        ...
        rows.add(new ExperimentRow(
                new OversamplingFramework(
                        ...
                        new SMOTEStrategy(1000, UnlabeledControlStrategyType.FIXED_RATIO_THRESHOLD, NeighborsNumStrategyType.ERROR_DRIVEN_UNIFORM,
                ...
                "SMOTE-erruniform-lbl" + "-b" + this.budget, "k=1"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-erruniform-lbl" + "-b" + this.budget, "k=10"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-erruniform-lbl" + "-b" + this.budget, "k=25"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-erruniform-lbl" + "-b" + this.budget, "k=50"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-erruniform-lbl" + "-b" + this.budget, "k=100"
        ));
