...
public class OS_SMOTEFixedNeighborsNumExperiment extends Experiment {

    private double budget;

    public OS_SMOTEFixedNeighborsNumExperiment(String inputDir, String outputDir) {
    ...
    public List<ExperimentRow> createExperimentRows() {
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-fix-lbl" + "-b" + this.budget, "k=1"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-fix-lbl" + "-b" + this.budget, "k=10"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-fix-lbl" + "-b" + this.budget, "k=25"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-fix-lbl" + "-b" + this.budget, "k=50"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-fix-lbl" + "-b" + this.budget, "k=100"
        ));
