...
public class OS_SMOTEFixedUniformNeighborsNumExperiment extends Experiment {

    private double budget;

    public OS_SMOTEFixedUniformNeighborsNumExperiment(String inputDir, String outputDir) {
    ...
    public List<ExperimentRow> createExperimentRows() {
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-uniform-lbl" + "-b" + this.budget, "k=1"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-uniform-lbl" + "-b" + this.budget, "k=10"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-uniform-lbl" + "-b" + this.budget, "k=25"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-uniform-lbl" + "-b" + this.budget, "k=50"
        ));
        ...
        rows.add(new ExperimentRow(
                ...
                "SMOTE-uniform-lbl" + "-b" + this.budget, "k=100"
        ));
