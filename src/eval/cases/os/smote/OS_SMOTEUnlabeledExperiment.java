...
public class OS_SMOTEUnlabeledExperiment extends Experiment {

    public OS_SMOTEUnlabeledExperiment(String inputDir, String outputDir) {
    ...
    public List<ExperimentRow> createExperimentRows() {
        ...
        rows.add(new ExperimentRow(
                new OversamplingFramework(
                        ...
                        new SMOTEStrategy(10, UnlabeledControlStrategyType.FIXED_RATIO_THRESHOLD, NeighborsNumStrategyType.FIXED_UNIFORM,
                                GenerationsNumStrategy.FIXED, GenerationStrategyType.LINE)
                                .setLuRatioThreshold(0.67)
        ...
        rows.add(new ExperimentRow(
                new OversamplingFramework(
                        ...
                        new SMOTEStrategy(50, UnlabeledControlStrategyType.FIXED_RATIO_THRESHOLD, NeighborsNumStrategyType.FIXED_UNIFORM,
                                GenerationsNumStrategy.FIXED, GenerationStrategyType.LINE)
                                .setLuRatioThreshold(0.67)
        ...
        rows.add(new ExperimentRow(
                new OversamplingFramework(
                        ...
                        new SMOTEStrategy(200, UnlabeledControlStrategyType.FIXED_RATIO_THRESHOLD, NeighborsNumStrategyType.FIXED_UNIFORM,
                                GenerationsNumStrategy.FIXED, GenerationStrategyType.LINE)
                                .setLuRatioThreshold(0.67)
        ...
        rows.add(new ExperimentRow(
                new OversamplingFramework(
                        ...
                        new SMOTEStrategy(500, UnlabeledControlStrategyType.FIXED_RATIO_THRESHOLD, NeighborsNumStrategyType.FIXED_UNIFORM,
                                GenerationsNumStrategy.FIXED, GenerationStrategyType.LINE)
                                .setLuRatioThreshold(0.67)
